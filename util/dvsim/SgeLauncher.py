...
class SgeLauncher(Launcher):
    ...
    def _do_launch(self):
        ...
        try:
            ...
            sgeJob.args.sync = 'y'      # wait for the job to complete before exiting
            sgeJob.args.q = 'vcs_q'   # Define an array job with 20 subjobs
            sgeJob.args.l = 'mf=20G'  # memory req,request the given resources
